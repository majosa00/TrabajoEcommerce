                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" step="0.01" name="weight" id="weight"
                                        required>
                                    <div class="invalid-feedback">
                ...
                <div class="modal-body">
                    <form class="needs-validation" novalidate method="POST"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="flavor">Flavor:</label>
                                <input type="text" class="form-control" name="flavor" value="{{ $product->flavor }}"
                                    id="flavor" required>
                                <div class="invalid-feedback">
                                    Please enter the product flavor.
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="weight">Weight:</label>
                                    <input type="number" class="form-control" value="{{ $product->weight }}" step="0.01"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="iva">IVA:</label>
                                    <input type="number" class="form-control" value="{{ $product->iva }}" step="0.01"
