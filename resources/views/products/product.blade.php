                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('products.create') }}" method="post" class="needs-validation"
                                    novalidate>
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="flavor" id="flavor"
                                                required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="udpack" id="udpack"
                                                    required>
                                                <div class="invalid-feedback">
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    <td><img src="{{ optional($product->images)->imagen_1 ? asset('storage/' . $product->images->imagen_1) : '' }}"
                                            class="fotoproductoadmin" alt="{{ $product->name }}"></td>
                                    <td>{{ $product->name }}</td>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        value="{{ $product->price }}" step="0.01" name="price"
                                                        id="price" required>
                                                    <div class="invalid-feedback">
                                                        Please enter the product price.
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="dimension">Dimensions:</label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $product->dimension }}" step="0.01"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="weight">Weight:</label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $product->weight }}" step="0.01" name="weight"
                                                        id="weight" required>
                                                    <div class="invalid-feedback">
                                                        Please enter the product weight.
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="stock">Stock:</label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $product->stock }}" name="stock" id="stock"
                                                        required>
                                                    <div class="invalid-feedback">
                                                        Please enter the product stock.
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="iva">IVA:</label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $product->iva }}" step="0.01" name="iva"
                                                        id="iva" required>
                                                    <div class="invalid-feedback">
                                                        Please enter the applicable IVA.
                                                    </div>
