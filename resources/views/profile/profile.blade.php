                    ...
                    @if (!empty($addresses))
                        @foreach ($addresses as $address)
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <form action="{{ route('profile.deleteAddress', $address->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-danger btn-sm ms-2" type="submit"><i
                            ...
                            <div class="modal fade" id="updateAddressModal{{ $address->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="updateAddressModal" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('profile.updateAddress', $address->id) }}" method="POST">
                                                ...
                                                <input type="text" name="address" placeholder="Address"
                                                    class="form-control mb-2" value="{{ $address->address }}" autofocus>
                                    ...
                                    <form action="{{ route('profile.create-new-address') }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('profile.updateAddress', $address->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <!-- Formulario -->
                                                        <input type="text" name="address"
                                                            placeholder="Address"class="form-control mb-2"
