    ...
    <div id="main-container">
        <div class="container p-5">
            ...
            <section id="perfil">
                ...
                <!-- Cambiar datos user -->
                <h3 class="mt-2 mb-3">About you</h3>
                @auth
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="secondname" name="secondname" class="form-control mb-2"
                                        value="{{ old('secondname', Auth::user()->secondname) }}"
                ...
                <!-- Direcciones -->
                <h3 class="mt-2 mb-3">Your addresses</h3>
                <div class="col-md-6">
                    ...
                    @foreach ($addresses as $address)
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="btn-group">
                                    <a href="#updateAddressModal" class="btn btn-primary btn-sm mt-2" data-bs-toggle="modal"
                                    ...
                                    <form action="{{ route('profile.deleteAddress', $address->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger btn-sm ms-2 mt-2" type="submit"><i
                                        ...
                                        <form action="{{ route('profile.updateAddress', $address->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $address->country }}" name="country" id="country"
                                                    required>
                                                <div class="invalid-feedback">
                ...
                <div class="modal fade" id="newAddressModal" tabindex="-1" aria-labelledby="newAddressModal"
                    aria-hidden="true">
                    <div class="modal-dialog movil">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <!-- Cambiar contraseña -->
                <div class="row mb-3">
                    <h3 class="mt-2 mb-3">Password</h3>
                    <div class="col-md-6">
